...
from preprocessing import preprocess_data_model1, preprocess_data_model3 , preprocess_data_model5,preprocess_data_model6
...
def train_content_quality_model3 (json_path):
    
    df_raw = pd.read_json(json_path)

    df_raw = df_raw.fillna("")
    df_processed= preprocess_data_model1(df_raw)
    ...
    joblib.dump(model_pipeline,"ml_engine/saved_models/text_quality_model8.joblib")
    return model_pipeline

def train_content_quality_model4 (json_path):
    
    df_raw = pd.read_json(json_path)

    df_raw = df_raw.fillna("")
    df_processed= preprocess_data_model6(df_raw)

    df_processed = df_processed.fillna("")

    X_text=df_processed['clean_summary']
    y=df_processed['is_summary_content_good']
    X_train , X_test ,Y_train,Y_test =train_test_split(X_text,y,test_size=0.2,random_state=42)
    ...
    joblib.dump(vectorisor,"ml_engine/saved_models/vectorisor_model9.joblib")
    model_pipeline=MLPClassifier(hidden_layer_sizes=(32,16),activation='relu',solver='lbfgs',max_iter=500,random_state=42)
    # param_grid={
    #     'hidden_layer_sizes': [(32,16),(50,25)],
    #     'max_iter': [250,500,750,1000]
    ...
    joblib.dump(model_pipeline,"ml_engine/saved_models/text_quality_model9.joblib")
    return model_pipeline
...
if __name__ == "__main__":
    ...
    # train_content_quality_model1(r'C:\Users\yjamal\Desktop\JiraTicketAudit\JiraTicketAudite\JiraTicketAudit\ml_engine\test.json')
    train_content_quality_model1(r'C:\Users\yjamal\Desktop\JiraTicketAudit\JiraTicketAudite\JiraTicketAudit\ml_engine\test.json')
    train_content_quality_model2(r'C:\Users\yjamal\Desktop\JiraTicketAudit\JiraTicketAudite\JiraTicketAudit\ml_engine\test.json')
    train_content_quality_model3(r'C:\Users\yjamal\Desktop\JiraTicketAudit\JiraTicketAudite\JiraTicketAudit\ml_engine\test.json')
    train_content_quality_model4(r'C:\Users\yjamal\Desktop\JiraTicketAudit\JiraTicketAudite\JiraTicketAudit\ml_engine\test.json')